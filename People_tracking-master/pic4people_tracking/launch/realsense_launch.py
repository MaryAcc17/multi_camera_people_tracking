...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'decimation_filter.filter_magnitude','default': '2', 'description': 'discrete steps in [2-8] range'},                           
                           {'name': 'spatial_filter.enable',        'default': 'false', 'description': 'enable_spatial_filter'},
                           {'name': 'spatial_filter.filter_magnitude','default': '2', 'description': '[1-5] range'},
                           {'name': 'spatial_filter.holes_fill',    'default': '0', 'description': '[0-5] range '},
                           ...
                           {'name': 'hole_filling_filter.holes_fill','default': '1', 'description': '[0-2] enumerated: fill_from_left; farest_from_around; nearest_from_around'},

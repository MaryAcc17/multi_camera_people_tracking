...
#ifndef COMMON_UTILS__PATH_HANDLER_HPP_
#define COMMON_UTILS__PATH_HANDLER_HPP_
...
/**
 * @class common_utils::PathHandler
...
public:
  ...
  /**
   * @brief Resets the global plan to its original state before pruning.
   */
  void resetPlan();
  ...
  geometry_msgs::msg::PointStamped getTransformedGoal(
...
#endif  // COMMON_UTILS__PATH_HANDLER_HPP_
